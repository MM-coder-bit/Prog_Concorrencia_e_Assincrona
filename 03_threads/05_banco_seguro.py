...
#--------------------------------------------------------------------#
#--------------------------------------------------------------------#
# Este código é para corrigir o erro de race conditions  com o Lock  #
#--------------------------------------------------------------------#
#--------------------------------------------------------------------#
#--------------------------------------------------------------------#
...
lock = threading.RLock() # Cria um lock reentrante.
...
def main():
    ...
    with lock: # Bloqueia a operação para evitar condições de corrida.
